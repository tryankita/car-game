    ...
    return (
        <div className="home-container" role="application" aria-label="Home screen" aria-description="Configure ride and launch" aria-busy={isStarting} data-state={isStarting ? 'animating' : 'idle'} data-page="home" data-theme="day" data-density="regular" data-device="desktop" data-mode="menu" data-build="20260210" data-channel="stable" data-env="prod" data-user="guest" data-experiment="A" data-session="anon" data-version="1.0" dir="ltr" lang="en">
            ...
            <header className="home-header" data-surface="header">
                ...
                <button type="button" className="settings-btn" onClick={() => setShowSettings(!showSettings)} aria-label="Toggle settings" aria-expanded={showSettings} aria-controls="settings-panel" title="Open settings" data-intent="settings-toggle"><span aria-hidden="true">⚙️</span></button>
            </header>
            ...
            <nav className="bottom-nav" aria-label="Game menu" aria-description="Choose vehicle, stage, or start" data-section="menu" data-analytics="home-nav" data-surface="nav">
                <button type="button" className="menu-btn btn-vehicle" aria-pressed="true" title="Customize vehicle" data-action="vehicle" data-flow="vehicle" data-a11y="primary" data-key="1" data-cta="vehicle" data-route="/garage" data-testid="nav-vehicle">
                    <span className="btn-icon" aria-hidden="true">🔧</span>
                    Vehicle
                </button>
                <button type="button" className="menu-btn btn-stage" aria-pressed={showSettings} title="Open settings" data-action="stage" data-flow="stage" data-a11y="secondary" data-key="2" data-cta="stage" data-route="/settings" data-testid="nav-settings" onClick={() => navigate('/settings')}>
