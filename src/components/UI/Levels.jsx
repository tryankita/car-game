...
const contentWrapper = { position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 'clamp(0.3rem, 1.5vh, 1.5rem) 1rem', gap: 'clamp(0.2rem, 0.8vh, 1rem)', boxSizing: 'border-box' }
const headerStyle = { textAlign: 'center' }
const titleStyle = { fontSize: 'clamp(1rem, 3.5vw, 3rem)', fontWeight: 900, lineHeight: 1, letterSpacing: '0.08em', textTransform: 'uppercase', margin: 0, fontStyle: 'italic' }
...
const pageIndicatorTextStyle = { color: '#555', fontSize: '0.65rem', letterSpacing: '0.2em', marginTop: 'clamp(0.1rem, 0.4vh, 0.35rem)', fontFamily: "'Rajdhani', sans-serif", fontWeight: 600 }
const slideshowContainer = { display: 'flex', alignItems: 'center', gap: 'clamp(0.2rem, 0.6vw, 0.8rem)', width: '100%', maxWidth: '1100px' }
const arrowBtn = { flexShrink: 0, width: 'clamp(28px, 4vw, 48px)', height: 'clamp(28px, 4vw, 48px)', borderRadius: '50%', background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(8px)', border: '2px solid rgba(255,255,255,0.15)', color: '#fff', fontSize: 'clamp(0.75rem, 1.2vw, 1.2rem)', cursor: 'pointer', transition: 'all .25s', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Orbitron', sans-serif" }
...
const levelsGrid = { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'clamp(0.3rem, 0.8vw, 1.2rem)', width: '100%' }
const levelCard = { position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(0.1rem, 0.4vh, 0.3rem)', padding: 'clamp(0.35rem, 1vw, 1.2rem)', background: 'rgba(10,10,20,0.65)', backdropFilter: 'blur(10px)', border: '2px solid rgba(100,100,100,0.25)', borderRadius: '14px', transition: 'all 0.3s ease', boxShadow: '0 4px 16px rgba(0,0,0,0.5)', textAlign: 'center' }
...
const dotsRow = { display: 'flex', gap: 'clamp(0.25rem, 0.5vw, 0.5rem)', alignItems: 'center', justifyContent: 'center' }
const dotStyle = (active) => ({ width: active ? 'clamp(16px, 2vw, 24px)' : 'clamp(7px, 1vw, 10px)', height: 'clamp(7px, 1vw, 10px)', borderRadius: '5px', background: active ? '#00b4ff' : 'rgba(255,255,255,0.15)', border: 'none', cursor: 'pointer', transition: 'all 0.3s ease', boxShadow: active ? '0 0 10px rgba(0,180,255,0.5)' : 'none', padding: 0 })
const buttonsContainer = { display: 'flex', gap: 'clamp(0.5rem, 1.5vw, 1.5rem)' }
const backButton = { minWidth: 'clamp(90px, 12vw, 140px)', padding: 'clamp(0.4rem, 1.2vh, 0.85rem) clamp(0.8rem, 2vw, 2rem)', fontSize: 'clamp(0.6rem, 1.4vw, 0.9rem)', fontWeight: 700, fontFamily: "'Orbitron', sans-serif", color: '#fff', background: 'rgba(10,10,20,0.7)', backdropFilter: 'blur(10px)', border: '2px solid rgba(100,100,100,0.5)', borderRadius: '8px', cursor: 'pointer', transition: 'all .3s', textTransform: 'uppercase', letterSpacing: '0.12em', boxShadow: '0 4px 20px rgba(0,0,0,0.5)', outline: 'none' }
const startButton = { minWidth: 'clamp(120px, 16vw, 180px)', padding: 'clamp(0.4rem, 1.2vh, 0.85rem) clamp(0.8rem, 2vw, 2rem)', fontSize: 'clamp(0.6rem, 1.4vw, 0.9rem)', fontWeight: 700, fontFamily: "'Orbitron', sans-serif", color: '#fff', background: 'rgba(0,180,255,0.2)', backdropFilter: 'blur(10px)', border: '2px solid #00b4ff', borderRadius: '8px', transition: 'all .3s', textTransform: 'uppercase', letterSpacing: '0.12em', boxShadow: '0 0 20px rgba(0,180,255,0.4), 0 4px 20px rgba(0,0,0,0.5)', outline: 'none' }
