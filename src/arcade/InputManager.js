export class InputManager {
    ...
    destroy() {
        // Reset state so no lingering inputs
        this.moveLeft = false;
        this.moveRight = false;
        this.isTouching = false;
        this.isGameOver = true;
        // Bound handlers were anonymous, so we can't remove them precisely.
        // Setting isGameOver=true ensures they are no-ops going forward.
    }
}
