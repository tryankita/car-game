...
export class NeonRushGame {
    constructor(onGoHome) {
        this.roadLength = 200;
        this.roadWidth = 10;
        this._onGoHome = onGoHome || null;
        this._rafId = null;

        this.sceneManager = new SceneManager('arcade-container', this.roadLength);
    ...
    destroy() {
        ...
        try { this.soundManager.stopEngine(); } catch (e) {}
        try { this.inputManager.destroy(); } catch (e) {}
        try { this.sceneManager.dispose(); } catch (e) {}
    }
}

// Export only — instantiation done in ArcadeGame.jsx
